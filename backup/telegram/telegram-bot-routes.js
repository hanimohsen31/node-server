...
bot.on('message', async (msg) => {
  ...
  try {
    let finalResult = { username, chatId, messageText, message_id: msg.message_id, date: msg.date, category, status: 'pending' }
...
bot.on('callback_query', async (query) => {
  ...
  const updated = await AmaraBot.findOneAndUpdate(
    { chatId, date: query.message.date, status: 'pending' }, // filter
